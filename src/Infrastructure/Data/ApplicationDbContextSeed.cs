...
namespace Infrastructure.Data
{
    public class ApplicationDbContextSeed
    {
        public static async Task SeedAsync(ApplicationDbContext dbContext)
        {
            ...
            Category cat1 = new Category() { CategoryName = "Mens" };
            ...
            Brand brand1 = new Brand() { BrandName = "Citizen" };
            Brand brand2 = new Brand() { BrandName = "Casio" };
            Brand brand3 = new Brand() { BrandName = "CALVİN KLEIN" };
            Brand brand4 = new Brand() { BrandName = "Fossil" };
